/**
 * Brand-glyph SVGs for the OAuth provider buttons.
 * lucide-react omits brand marks for trademark reasons, so we ship our own.
 */
...
export function MicrosoftIcon({ size = 18, className }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 23 23" aria-hidden="true">
